...
candle silent.wxs net4.6.0.wxs
light -ext WixUIExtension -ext WixUtilExtension -cultures:en-us silent.wixobj net4.6.0.wixobj -b BIN -out xdmsetup-%BUILD_VER%-x86.msi
